...
router.post('/submit', async (req, res) => {
  ...
  var data = {
    ...
    public: req.body['blog_privacy'] == 'public' || req.body['blog_privacy'] == 'unlisted',
    hidden: req.body['blog_privacy'] == 'unlisted' || req.body['blog_privacy'] == 'private',
...
router.get('/:slug', async (req, res) => {
  ...
  res.render(`blogs/view.ejs`, { blog, previousLink: `/`, renderAnalytics: shouldShowAnalytics, isPreviewMode: false, analytics })
